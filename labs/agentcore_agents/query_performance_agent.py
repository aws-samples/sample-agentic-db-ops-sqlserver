...
- get_index_usage_stats: Index usage statistics (identify unused indexes)
...
4. **For optimization**:
   ...
   - Use get_index_usage_stats to find unused indexes
...
def query_performance_agent(payload, context=None):
    """Invoke the Query Performance Agent with a payload"""

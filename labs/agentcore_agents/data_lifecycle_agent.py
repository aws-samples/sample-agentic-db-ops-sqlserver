...
- Queue Depth: [Bottleneck: YES/NO]

## Storage Recommendations
1. **Type**: [gp2/gp3/io2]
2. **Action**: [Specific recommendation]
3. **Benefit**: [Cost savings / Performance improvement]

## TempDB Analysis
- Size: [X GB, Y% used]
- Configuration: [File count, issues]
- Bottlenecks: [Space/Contention/I/O]

## Action Items
1. **Critical**: [Immediate actions]
2. **High**: [Important optimizations]
3. **Medium**: [Maintenance tasks]"""
...
def data_lifecycle_agent(payload, context=None):
    """Invoke the Data Lifecycle agent with a payload"""

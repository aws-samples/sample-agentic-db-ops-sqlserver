...
system_prompt = """You are a TOOL EXECUTOR for RDS SQL Server security checks (AWS-level).
...
2. Do NOT score, classify, or assign severity (no security score, no CRITICAL/OK).
...
Return the raw tool outputs for the checks performed (encryption, compliance, RDS security). Do not compute a score, classify issues, or format a report — the Supervisor interprets the data."""
...
if __name__ == "__main__":
    print("Security Audit Agent - AWS-focused security audit for RDS SQL Server.")
